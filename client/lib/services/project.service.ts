...
import { toPrismaCreateInput, toApiResponse } from '@/lib/mappers/project.mapper';
import { z } from 'zod';
...
export const createProjectSchema = z.object({
  ...
  tags: z.array(z.object({ id: z.number(), order: z.number() })).optional(),
  techItems: z.array(
    z.object({
      id: z.number(),
  ...
  roles: z.array(z.object({ id: z.number(), order: z.number() })).optional(),
  sections: z.array(
    z.object({
      order: z.number(),
      title: z.string(),
      layoutType: z.enum(['imgTopTextBottom', 'imgLeftTextRight', 'imgRightTextLeft', 'textTopImgMiddleTextBottom']),
      contentTexts: z.array(z.object({ content: z.string() })).optional(),
      contentImages: z.array(z.object({ url: z.string().url(), alt: z.string().optional() })).optional(),
